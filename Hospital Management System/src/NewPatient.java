...
public class NewPatient extends JFrame implements ActionListener {
    ...
    public NewPatient() {
        ...
        tfP_name.setBounds(200, 110, 300, 30);
        add(tfP_name);
        ...
        jlAge.setBounds(440, 160, 150, 30);
        ...
        jlB_grp.setBounds(440, 210, 150, 30);
        ...
        jlphn.setBounds(440, 260, 150, 30);
        ...
        jlDOR.setBounds(500, 310, 300, 30);
        ...
        tfG_name.setBounds(200, 370, 300, 30);
        add(tfG_name);
