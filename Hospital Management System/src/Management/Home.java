...
public class Home extends JFrame implements ActionListener {
    ...
    public Home() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Backgroundimage/home.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1120, 630, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(8, 0, 1090, 600);
        add(image);
        ...
        developer.setBounds(650, 210, 150, 40);
        ...
        remove.setBounds(850, 210, 150, 40);
